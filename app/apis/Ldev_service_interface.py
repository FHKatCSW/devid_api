...
class LDevIDKey(Resource):
    ...
    def delete(self, keyIndex):
        """LDevID key delete (7.2.10)"""
        # The DevID module performs cryptographic zeroization on LDevID key storage as part of the delete
...
class LDevIDKeyGenerate(Resource):
    ...
    def post(self, keyIndex):
        """LDevID key generate (7.2.8)"""
        # This operation allows the device administrator to generate an additional LDevID key within the DevID
...
class LDevIDKeyInsert(Resource):
    @api.doc("post")
    def post(self, keyIndex):
        """LDevID key insert (7.2.9)"""
        # This operation allows the device administrator to insert an externally generated LDevID key into the DevID
        # module.
        return {"status": "NotImplemented"}
...
class LDevIDCert(Resource):
    ...
    def delete(self, certificateIndex):
        """LDevID certificate delete (7.2.13)"""
        # This operation implicitly deletes any certificate chain associated with the deleted certificate, it does not
    ...
    def get(self, certificateIndex):
        """LDevID certificate export (NOT STANDARDIZED)"""
        # Exports a certificate associated to a certificateIndex.
        return {"status": "NotImplemented"}
...
class LDevIDChain(Resource):
    ...
    @api.doc("post")
    def post(self, certificateIndex):
        """LDevID certificate chain insert (7.2.12)"""
        # A certificate chain to be associated with a certificateIndex
        return {"status": "NotImplemented"}

    @api.doc("get")
    def get(self, certificateIndex):
        """LDevID certificate chain export (NOT STANDARDIZED)"""
        # Exports a certificate chain associated to a certificateIndex.
        return {"status": "NotImplemented"}

    @api.doc("delete")
    def delete(self, certificateIndex):
        """LDevID certificate chain delete (7.2.14)"""
        # The DevID module performs cryptographic zeroization on LDevID certificate chain material as part of
        # the delete process.
        return {"status": "NotImplemented"}
