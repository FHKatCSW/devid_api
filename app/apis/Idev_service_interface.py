...
class IDevIDKeyGenerate(Resource):
    ...
    def post(self, keyIndex):
        """IDevID key generate (NOT STANDARDIZED)"""
        # This operation allows the device administrator to generate an  IDevID key within the DevID
...
class IDevIDCert(Resource):
    ...
    def delete(self, certificateIndex):
        """IDevID certificate delete (NOT STANDARDIZED)"""
...
class IDevIDChain(Resource):
    ...
    @api.doc("get")
    def get(self, certificateIndex):
        """IDevID certificate chain export (NOT STANDARDIZED)"""
        # Exports a certificate chain associated to a certificateIndex.
        return {"status": "NotImplemented"}

    @api.doc("delete")
    def delete(self, certificateIndex):
        """IDevID certificate chain delete (NOT STANDARDIZED)"""
        # The DevID module performs cryptographic zeroization on IDevID certificate chain material as part of
        # the delete process.
        return {"status": "NotImplemented"}
